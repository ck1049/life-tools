...
public class MybatisPlusFastAutoGeneratorUtils {
    ...
    public static void main(String[] args) {
        String outputDir = "lottery\\src\\main\\java";
        Map<OutputFile, String> pathInfo = new HashMap<>();
        pathInfo.put(OutputFile.xml, "lottery\\src\\main\\resources\\mapper");
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3308/lottery2?useUnicode=true&characterEncoding=utf8" +
                ...
                .packageConfig(builder -> {
                    builder.parent("com.loafer.lottery") // 设置父包名
